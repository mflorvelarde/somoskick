                            ...
                            <div class="nav-tabs-custom" id="navbar">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab-informacion">
                                                ...
                                                <div class="box box-widget widget-user-2">
                                                    <div class="box-footer no-padding">
                                                            <ul class="nav nav-stacked" id="camada-info">
                                                                ...
                                                                <li>
                                                                    <a href="<?php echo $this->Url->build(["controller" => "Cuotas","action" => "view", $camada->grupo->tarifas_aplicada->id]);?>">
                                                                        Tarifa <span class="pull-right badge bg-green"><?= h($camada->grupo->tarifas_aplicada->tarifa->descripcion)?></span>
                                                                    </a>
                                                                </li>
                                                                ...
                                                                <li><a>Vendedor <span class="pull-right badge bg-aqua"><?= h($camada->persona->nombre)?></span></a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <?= $this->Html->link(__('Editar camada'), ['action' => 'edit', $camada->id] , array('class'=>'btn bg-maroon margin-bottom') ) ?>
                                            </div>
                                        </div>
                                    </div>
