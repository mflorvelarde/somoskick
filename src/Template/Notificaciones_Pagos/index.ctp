		 ...
		 Listado de Personas
	      ...
	      <div class="panel-body">
			...
			<tr>
		      ...
		      <tbody>
			  <?php foreach ($notificacionesPagos as $notificacionesPago): ?>
			  <tr>
			      <td><?= $this->Number->format($notificacionesPago->id) ?></td>
			      <td><?= $this->Number->format($notificacionesPago->monto_pesos) ?></td>
			      <td><?= $this->Number->format($notificacionesPago->monto_dolares) ?></td>
